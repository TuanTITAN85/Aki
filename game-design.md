...
### 3.4 Chú Cún đồng hành 🐕
- Mua từ cửa hàng (200 vàng). Khi mua, người chơi được đặt tên cho Cún (tối đa 14 ký tự).
- **Golden Retriever pixel art** — sprite 14×10 grid, 6 frame (idle/walk/attack).
- **Bất tử** — không có HP riêng, không bị đánh bại.
- **AI**: khi có lính hoặc thú rừng trong bán kính **~300px**, Cún tự chạy tới cắn (sát thương 20, cooldown 35 frames). Khi không có địch gần, Cún di chuyển theo sát bên cạnh Hải tặc.
- **Cún bị reset khi Game Over** — bắt đầu ván mới sẽ mất Cún và phải mua lại.
- Tên Cún hiển thị phía trên sprite bằng màu vàng.
...
### Đồng hành
- **Chú Cún Golden Retriever** — 200 vàng, có thể đặt tên khi mua. Cún cắn lính/thú trong phạm vi ~300px. Đã mua rồi thì không mua lại được nữa.
...
| | `companion.js` | ~150 | class CompanionDog + sprite Golden Retriever + AI |
...
- ✅ **Chú Cún đồng hành** (Golden Retriever) — mua 200 vàng, đặt tên được, cắn lính/thú trong phạm vi 300px, bất tử, bị reset khi Game Over
